...
@Configuration
@EnableTransactionManagement // Enables declarative Transaction Manager.
public class AppConfig {
	...
	@Bean
	public LocalContainerEntityManagerFactoryBean emf(DataSource ds) { // arguments will be auto wired.
		// Spring Version
